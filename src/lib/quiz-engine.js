...
export function generateFillBlank(terms, targetLang, count = 5) {
  ...
  return selected.map(term => {
    ...
    return {
      ...
      exampleKo: term.exampleKo || '',
      exampleZh: term.exampleZh || '',
      exampleEs: term.exampleEs || '',
      examplePt: term.examplePt || '',
      exampleRu: term.exampleRu || '',
      exampleDe: term.exampleDe || '',
      exampleFr: term.exampleFr || '',
      exampleHi: term.exampleHi || '',
      correctAnswer,
      options,
      category: term.category,
    }
